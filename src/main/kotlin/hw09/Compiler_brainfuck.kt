...
public class Compiler_brainfuck() {
    private fun getClassWriter(input: String): ClassWriter {
        val cw = ClassWriter(0)
        cw.visit(V1_7, ACC_PUBLIC, "Compiler_brainfuck", null, "java/lang/Object", null)
    ...
    private fun loadClassAndRun(classByteArray: ByteArray) {
        ...
        val exprClass = cl.loadClass("Compiler_brainfuck", classByteArray)
