...
class KotlinTests {
    ...
    fun createListArray(): KotlinOrderedListArray<Int> {
        val list = KotlinOrderedListArray<Int>()
        list.add(1)
        list.add(4)
        list.add(2)
        list.add(5)
    ...
    fun createListATD(): KotlinOrderedListATD<Int> {
        val list = KotlinOrderedListATD<Int>()
        list.add(6)
        list.add(12)
        list.add(24)
        list.add(22)
