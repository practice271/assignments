...
internal class BrainfuckCompilerTest() {
    ...
    private fun test(program : String, input : String, result : Any) {
        val classByteArray = compiler.generateByteArray(program, input)
        loadClassAndRun(classByteArray)

        var output = File("programOutput.out").readText()
        var temp   = ""
