...
public class AVLTest {
    ...
    @Test fun insertion() {
        val t: AVLtree = AVLtree()
        assertEquals("TIE", t.clrstr())

        t.insert(4)
        assertEquals("4 ", t.clrstr())

        t.insert(2); t.insert(3)
        assertEquals("3 2 4 ", t.clrstr())

        t.insert(1)
        assertEquals("3 2 1 4 ", t.clrstr())
    }
    ...
    @Test fun deletion() {
        ...
        t.delete(10)
        assertEquals("12 2 6 15 14 17 100 ", t.clrstr())

        t.delete(14)
        assertEquals("12 2 6 17 15 100 ", t.clrstr())
    }
